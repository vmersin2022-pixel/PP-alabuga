              ...
              <div key={s.id} className="flex-[0_0_100%] md:flex-[0_0_calc(50%-0.75rem)] lg:flex-[0_0_calc(25%-1.125rem)] min-w-0 py-4">
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full transition-opacity duration-500 md:group-hover/card:opacity-0 group-[.is-active]:opacity-0">
                    <div className="mb-4 lg:mb-6 transition-transform duration-700 origin-left md:group-hover/card:scale-110 group-[.is-active]:scale-110 text-blue-600">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-slate-900 to-slate-800 opacity-0 md:group-hover/card:opacity-100 group-[.is-active]:opacity-100 transition-opacity duration-500 flex flex-col justify-center p-6 lg:p-8 z-20">
                    <h3 className="text-xl lg:text-2xl font-bold text-white mb-3 lg:mb-4 transform translate-y-4 opacity-0 md:group-hover/card:translate-y-0 md:group-hover/card:opacity-100 group-[.is-active]:translate-y-0 group-[.is-active]:opacity-100 transition-all duration-500 delay-75">
                      {s.assets.hubCard.title}
                    </h3>
                    <p className="text-sm lg:text-base text-slate-300 leading-relaxed mb-6 lg:mb-8 transform translate-y-4 opacity-0 md:group-hover/card:translate-y-0 md:group-hover/card:opacity-100 group-[.is-active]:translate-y-0 group-[.is-active]:opacity-100 transition-all duration-500 delay-150">
