      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {works.map((work, index) => (
            <div 
              key={index} 
              className="rounded-3xl overflow-hidden shadow-lg shadow-slate-200/50 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 bg-white relative group cursor-pointer border border-slate-100 flex flex-col"
            ...
            >
              <div className="relative overflow-hidden aspect-[4/5]">
                ...
                />
                <div className="absolute inset-0 bg-slate-900/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-center p-8">
                  <ul className="space-y-3 text-white mb-6 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-100">
              ...
              <div className="p-6 bg-white relative z-10 flex-grow flex flex-col justify-center">
