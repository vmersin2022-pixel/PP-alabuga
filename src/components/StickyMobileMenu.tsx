  ...
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 px-4 pb-6 pt-2">
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 dark:border-white/5 rounded-[28px] shadow-[0_-10px_40px_rgba(0,0,0,0.1)] flex justify-around p-3">
          <motion.a 
            whileTap={{ scale: 0.9 }}
            href="tel:+79656212493" 
            className="flex flex-col items-center text-slate-600 dark:text-slate-400 active:text-slate-900 dark:active:text-white transition-colors"
          >
            <div className="p-2 rounded-2xl bg-slate-50 dark:bg-slate-800 mb-1">
          ...
          >
            <div className="p-2 rounded-2xl bg-blue-50 dark:bg-blue-500/10 mb-1">
          ...
          <motion.button 
            whileTap={{ scale: 0.9 }}
            onClick={onOpenModal} 
            className="flex flex-col items-center text-orange-600 dark:text-orange-400 active:text-orange-700 dark:active:text-orange-300 transition-colors border-none bg-transparent"
          >
            <div className="p-2 rounded-2xl bg-orange-50 dark:bg-orange-500/10 mb-1">
